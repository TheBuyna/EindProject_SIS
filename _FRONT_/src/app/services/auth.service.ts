...
export class AuthService {
  ...
  private REGISTER_URL = "https://wdev.be/buyna/be/api/register";
  private LOGIN_URL = "https://wdev.be/buyna/be/api/login_check";
  private CHECK_JWT = "https://wdev.be/buyna/be/apiCheck";
  private UPDATE_URL = 'https://wdev.be/buyna/be/api/updateuser';
  ...
  setTheme(theme: string) {
    ...
    return this.http.put('https://wdev.be/buyna/be/api/setTheme', themeJson, { headers: { 'Content-Type': 'application/json' } }).subscribe(
      (res) => {
        console.log(res);
      },
      (err) => {
