...
class AccountController extends BaseController
{
     ...
     * Default code generated by symfony - not used
     */
    ...
    {
        //Get the query from the searchbar for quirybuilder
        //if empty get all
        $q = $request->query->get('q');
        $queryBuilder = $repository->getWithSearchQueryBuilder($q);

        //Make pagination out of the querybuilder
     ...
     * Method for generating form to add new user
     */
     ...
     * Method to edit user with the given id
     */
